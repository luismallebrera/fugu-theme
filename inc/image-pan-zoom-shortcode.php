...
function fugu_theme_image_pan_zoom_shortcode($atts) {
    $atts = shortcode_atts([
        'image' => '',
        'zoom_min' => '1',
        'zoom_max' => '3',
...
add_shortcode('image_pan_zoom', 'fugu_theme_image_pan_zoom_shortcode');

function fugu_theme_enqueue_image_pan_zoom_assets() {
    wp_enqueue_style(
        'image-pan-zoom',
...
add_action('wp_enqueue_scripts', 'fugu_theme_enqueue_image_pan_zoom_assets');
