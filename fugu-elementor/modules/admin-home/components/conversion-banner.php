...
class Conversion_Banner {
	...
	const SCRIPT_HANDLE = 'fugu-conversion-banner';
	const NONCE_ACTION = 'ehe_cb_nonce';
	const OBJECT_NAME = 'ehe_cb';
	const USER_META_KEY = '_fugu_elementor_install_notice';
	...
	public function dismiss_theme_notice() {
		...
		wp_send_json_success( [ 'message' => __( 'Notice dismissed.', 'fugu-elementor' ) ] );
	}
