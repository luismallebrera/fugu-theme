...
use FuguTheme\Theme;
use FuguTheme\Modules\AdminHome\Components\Settings_Controller;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

add_action( 'init', 'fugu_elementor_tweak_settings', 0 );

function fugu_elementor_tweak_settings() {
	/**
 ...
 * @deprecated 3.4.0
 */
function fugu_elementor_register_settings( $settings_group, $settings ) {
	/**
	 * @var Settings_Controller $settings_controller
	 */
	$settings_controller = Theme::instance()
 ...
 * @deprecated 3.4.0
 */
function fugu_elementor_do_tweak( $setting, $tweak_callback ) {
	/**
	 * @var Settings_Controller $settings_controller
	 */
	$settings_controller = Theme::instance()
 ...
 * @deprecated 3.4.0
 */
function fugu_elementor_render_tweaks( $settings_group, $settings ) {
	/**
	 * @var Settings_Controller $settings_controller
	 */
	$settings_controller = Theme::instance()
